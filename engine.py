...
class CheckerBoard:
    ...
    def get_map_str(self):
        ...
        for row in self.board:
            for cell in row:
                if cell is None:
                    map_str += "None"  # If the cell is empty, add "None" to the string
                else:
                    map_str += str(cell) + " " # Add the string representation of the cell to the string
    ...
    def attack(self, s_tup, t_tup):
        ...
        if is_adjacent(s_tup, t_tup):
            ...
            if isinstance(s, Units) and isinstance(t, Units):
                ...
                #Return the damage values as a dictionary
                return {'damage_to_t': damage_value_to_t, 'damage_to_s': damage_value_to_s}
        else:
        ...
        if is_adjacent(s_tup, t_tup):
            ...
            if isinstance(s, Units) and isinstance(t, Units):
                if s.get_faction() == t.get_faction():
                    ...
                    return {'restored_value': repair_value_s_2_t}
            else:
